...
export default function RecommandationsPage() {
  ...
  return (
    <div className="h-full flex bg-[url('/bg3.jpg')] bg-cover bg-no-repeat bg-center flex-col bg-gradient-to-br from-blue-100 via-white to-blue-300 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 animate-gradient-slow relative overflow-scroll bg-white text-emerald-900 dark:bg-gray-900 dark:text-emerald-100">
